...
return [
    ...
    "orchestra/foundation" => [
        ...
        "src/Filters/Authenticate",
        "src/Filters/CanBeInstalled",
        "src/Filters/CanManage",
        "src/Filters/IsGuest",
        "src/Filters/IsInstalled",
        "src/Filters/IsRegistrable",
        "src/Filters/VerifyCsrfToken",
        "src/Middleware/UseBackendTheme",
        "src/Application",
        "src/Foundation",
        "src/Meta",
    ],
